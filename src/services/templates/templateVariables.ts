...
export function renderLeadMessages<T extends TemplateVariableContext>(
  lead: T,
  messages: { message1?: string; message2?: string; message3?: string; message4?: string; message_1?: string; message_2?: string; message_3?: string; message_4?: string },
) {
  ...
  return { message1, message2, message3, message4, message_1: message1, message_2: message2, message_3: message3, message_4: message4 };
}
