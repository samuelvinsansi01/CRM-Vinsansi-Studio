...
function pagedWhatsAppLead(row: Row): WhatsAppQueueLead {
  ...
  return {
    ...
    status, batchId: String(row.queue_id ?? ''), batch_id: String(row.queue_id ?? ''), batch_number: Number(row.dispatch_batch_number ?? 1),
    dispatch_batch_number: Number(row.dispatch_batch_number ?? 1), dispatch_batch_count: Number(row.dispatch_batch_count ?? 1), dispatch_batch_size: Number(row.dispatch_batch_size ?? 1), dispatch_batch_position: Number(row.dispatch_batch_position ?? 1),
