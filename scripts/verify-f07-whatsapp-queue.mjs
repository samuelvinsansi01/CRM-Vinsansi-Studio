...
assert(worker.includes("const VERSION = '2.7.0'"), 'Worker precisa estar na versão 2.7.0.');
...
assert(JSON.parse(workerPackage).version === '2.7.0', 'package.json do Worker precisa refletir 2.7.0.');
