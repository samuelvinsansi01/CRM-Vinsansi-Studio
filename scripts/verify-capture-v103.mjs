...
assert.match(source, /maps_desired_limit_not_synced/);
assert.match(source, /desired_company_count_reached/);
assert.match(source, /const EXTENSION_VERSION = '1\.0\.3'/);
...
console.log('CRM R8: Captura 1.0.3 usa quantidade única e revisão manual antes da importação.');
