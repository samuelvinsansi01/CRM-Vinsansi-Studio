...
const checks = [
  ...
  ['revalidação restaura PRE_SEND antes do prune', review.indexOf('await restoreWhatsAppValid(item.batchId, validation.approvedIds)') < review.indexOf('await prune(item.batchId).catch')],
];
