...
pass('candidate identity and stage',()=>{assert.equal(manifest.release,'2.4.0-R60.25');assert.equal(manifest.releaseStage,'candidate');assert.equal(manifest.releaseSequence,60);});
